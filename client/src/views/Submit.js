        ...
        <div className={submitformStyle.formcontainer}>
          ...
          <form>
            <div className={submitformStyle.left}>
              ...
              <textarea
                className={submitformStyle.title}
                placeholder="Ex: Book meals and table in advance"
                value={title}
              ...
              <textarea
                className={submitformStyle.description}
                placeholder="Ex: A few days ago, I went out to have dinner with my spouse. We had to wait for ......"
                value={description}
            ...
            <div className={submitformStyle.right}>
              <label className={submitformStyle.name}>
                Name:
                <input
                  type="text"
                  value={name}
              ...
              <label className={submitformStyle.email}>
                Email:
                <input
                  type="email"
              ...
              <label className={submitformStyle.social}>
                Social Media Link:
                <input
                  type="url"
                  value={social}
                  placeholder="https://www.twitter.com/user_name"
